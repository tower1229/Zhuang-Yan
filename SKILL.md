...
1. Read `{baseDir}/references/initialization-flow.md` before starting the interview.
2. Read `{baseDir}/references/write-safety.md` before drafting or writing any file.
