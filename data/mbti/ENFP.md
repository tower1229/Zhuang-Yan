...
**INTJ**（互补型）
INTJ 的深度、独立性和战略性给了 ENFP 一个真正的思维挑战，而不只是情感上的回应。ENFP 的温暖和开放心态解锁了 INTJ 难以自行触达的情感深度；INTJ 的方向感为 ENFP 的发散提供了真正的收敛点，而不是束缚。

**INFJ**（互补型）
INFJ 的洞察力和情感深度，给了 ENFP 最渴望的那种"被真正看见"的感觉。ENFP 的活力和创意激活了 INFJ 内心压抑的可能性感；两者都是 NF 外交家，共享对意义、联系和人类潜力的深刻信念。
