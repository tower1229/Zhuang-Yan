...
- `references/runtime-context/` 中包含 `persona-canon-template.md`、`execution-trigger-protocol-template.md`、`quality-calibration.md`
...
- 确认 `references/` 下的新层级路径与 `scripts/mbti-lookup.js` 一起正确匹配 `SKILL.md`
- 确认 `references/runtime-context/execution-trigger-protocol-template.md` 与 `references/runtime-context/quality-calibration.md` 已被纳入正常起草流程
